/* CS 1501 Summer 2020
   ...
   requires the following:
   	...
   	as the client program, yourself (however, you can build your client from the
   	ImprovedChatClient program that is provided for you).
	...
	try
	{
		while (true)
		{
			if (numUsers < MaxUsers)
			{
				try
				{
					// This is the handshaking code.  Look over this code when you
					// are doing the handshaking of your client.  For example, when
					// the server is writing to a client, your client should be reading
					// and when the server is reading, you should be writing.
					...
					// Get streams for connection to client
					...
					// Get key as BigInteger from client, then decrypt it
					// and use it to make the corresponding symmetric key
