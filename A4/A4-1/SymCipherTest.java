...
public class SymCipherTest
{
	public static void main (String [] args)
	{
		...
		String test2 = new String("ÅıÇÎ´Ï˝");  // use some chars > 128
		...
		// Note: Java Strings are arrays of 2-byte characters.  Thus, when getting the
		// underlying bytes from a Java String you will see the length is double the
